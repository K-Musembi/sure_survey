 ...
 * directly with Paystack. This implementation uses a blocking approach for consistency with the application's architecture.
 */
@Service
...
public class PaystackSubscriptionService {
     ...
     * @return The Paystack customer code upon successful creation.
     */
     ...
     * @return The {@link PaystackSubscriptionData} upon successful creation.
     */
    public PaystackSubscriptionData createSubscription(String customerCode, String planCode) {
