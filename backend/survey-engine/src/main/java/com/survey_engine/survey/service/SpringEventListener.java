...
public class SpringEventListener {
     ...
     */
    @EventListener
    public void handlePaymentSuccess(PaymentEventSuceeded event) {
        logger.info("Received PaymentEventSuceeded for surveyId: {}. Attempting to activate survey.", event.surveyId());
        try {
            ...
            logger.error("Could not parse surveyId from PaymentEventSuceeded: {}", event.surveyId(), e);
        } catch (Exception e) {
